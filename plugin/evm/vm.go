...
import (
	...
	nodeMetrics "github.com/SkyChains/chain/api/metrics"
	...
	"github.com/SkyChains/evm/eth/ethconfig"
	"github.com/SkyChains/evm/metrics"
	subnetEVMPrometheus "github.com/SkyChains/evm/metrics/prometheus"
	"github.com/SkyChains/evm/miner"
	"github.com/SkyChains/evm/node"
	...
	warpValidators "github.com/SkyChains/evm/warp/validators"
	...
	_ "github.com/SkyChains/evm/precompile/registry"
...
func (vm *VM) initBlockBuilding() error {
	...
	txGossipClient, err := vm.Network.NewAppProtocol(txGossipProtocol, txGossipHandler, p2p.WithValidatorSampling(vm.validators))
	if err != nil {
		return err
	}
